...
{
    internal partial class ShipperOutboxEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "HumanResources.Domain.OutBox.ShipperOutbox",
                typeof(ShipperOutbox),
                baseEntityType);
            ...
            key.AddAnnotation("Relational:Name", "pk_shipper_outboxes");

            var index = runtimeEntityType.AddIndex(
                new[] { id },
                unique: true);
            index.AddAnnotation("Relational:Name", "ix_shipper_outboxes_id");
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "shipper_outboxes");
