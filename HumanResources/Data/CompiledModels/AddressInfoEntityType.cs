...
{
    internal partial class AddressInfoEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "HumanResources.Domain.Customer.AddressInfo#AddressInfo",
                typeof(AddressInfo),
                baseEntityType,
                sharedClrType: true);
            ...
            customerId.AddAnnotation("Relational:ColumnName", "id");
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var addressInfo = principalEntityType.AddNavigation("AddressInfo",
                ...
                onDependent: false,
                typeof(AddressInfo),
                propertyInfo: typeof(Customer).GetProperty("AddressInfo", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Customer).GetField("<AddressInfo>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                eagerLoaded: true);

            runtimeForeignKey.AddAnnotation("Relational:Name", "fk_customers_customers_id");
