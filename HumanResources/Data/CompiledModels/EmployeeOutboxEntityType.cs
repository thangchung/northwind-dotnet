...
{
    internal partial class EmployeeOutboxEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "HumanResources.Domain.OutBox.EmployeeOutbox",
                typeof(EmployeeOutbox),
                baseEntityType);
            ...
            key.AddAnnotation("Relational:Name", "pk_employee_outboxes");

            var index = runtimeEntityType.AddIndex(
                new[] { id },
                unique: true);
            index.AddAnnotation("Relational:Name", "ix_employee_outboxes_id");
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "employee_outboxes");
