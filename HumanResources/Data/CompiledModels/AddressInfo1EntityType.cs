...
{
    internal partial class AddressInfo1EntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "HumanResources.Domain.Supplier.AddressInfo#AddressInfo",
                typeof(AddressInfo),
                baseEntityType,
                sharedClrType: true);
            ...
            supplierId.AddAnnotation("Relational:ColumnName", "id");
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var addressInfo = principalEntityType.AddNavigation("AddressInfo",
                ...
                onDependent: false,
                typeof(AddressInfo),
                propertyInfo: typeof(Supplier).GetProperty("AddressInfo", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Supplier).GetField("<AddressInfo>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                eagerLoaded: true);

            runtimeForeignKey.AddAnnotation("Relational:Name", "fk_suppliers_suppliers_id");
