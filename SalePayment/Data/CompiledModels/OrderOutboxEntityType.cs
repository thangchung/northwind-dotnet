...
{
    internal partial class OrderOutboxEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "SalePayment.Domain.Outbox.OrderOutbox",
                typeof(OrderOutbox),
                baseEntityType);
            ...
            key.AddAnnotation("Relational:Name", "pk_order_outboxes");

            var index = runtimeEntityType.AddIndex(
                new[] { id },
                unique: true);
            index.AddAnnotation("Relational:Name", "ix_order_outboxes_id");
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "order_outboxes");
